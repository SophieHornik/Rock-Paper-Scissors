...
=
`<h1 class="usertext">${username}'s
 <br> Choice</h1> <img id="userpic" src="usericonn (1).png" alt="..." />`
...
=
`${userChoice}.jpg`
  document.getElementById('comppic').src
=
`${compChoice}.jpg`
...
function
tie () {
  document.getElementById('winnerDisplayMsg').textContent
=
"It's a tie!"
}
...
+
1
document.getElementById('compScoreDisplay').textContent
=
`Comp's Score:
${compScore}`
